export default function Login() {
	return (
		<div className="flex h-screen items-center justify-center mx-auto">
			<div className="bg-green-400 px-20 py-10 rounded-xl">
				...
				<form className="flex flex-col">
					...
					<button className="py-fill bg-green-700 my-4 text-2xl font-extrabold text-white rounded border-2 border-black">
						Login
					</button>
